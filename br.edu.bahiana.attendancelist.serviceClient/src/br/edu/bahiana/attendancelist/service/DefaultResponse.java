...
public class DefaultResponse  implements java.io.Serializable {
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += new Long(getErrorNumber()).hashCode();
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.attendancelist.bahiana.edu.br", "DefaultResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("errorMessage");
        elemField.setXmlName(new javax.xml.namespace.QName("http://service.attendancelist.bahiana.edu.br", "errorMessage"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("errorNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("http://service.attendancelist.bahiana.edu.br", "errorNumber"));
